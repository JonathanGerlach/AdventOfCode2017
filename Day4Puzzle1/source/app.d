...
unittest
{
	enum example1 = "aa bb cc dd ee";
	enum example2 = "aa bb cc dd aa";
	enum example3 = "aa bb cc dd aaa";
...
bool isPassphraseValid(string passphrase)
{
	...
	// For each word, check how many matches it has in the array.  If there are any falses, then we return false.
	auto isValid = !words.map!(w => words.count(w) == 1).any!(a => a == false);
